        ...
        <div class="card-panel">
            ...
            <form action="editarCoordenador.php" method="post">
                ...
                <div class="input-field col s12 espacamento">
                    ...
                    <input placeholder="Digite o seu email" value="<?php echo $coordenador['email']; ?>" id="email" name="email" type="text" class="validate" pattern="^(?!\s*$)[^\s@']+@[^\s@']+$" required>
                ...
                <div class="row">
                    <div class="col s12">
                        <p class="center-align">
                            <button class="btn waves-effect waves-light #2e7d32 green darken-3 lighten-3" type="submit" name="action">Alterar coordenador de curso
