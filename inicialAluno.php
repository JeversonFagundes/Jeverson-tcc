                ...
                <table>
                    ...
                    <tbody>
                        ...
                        ?>
                                ...
                                echo '<td> <a href="' . $pastaDestino . $informacoes_entrega['caminho'] . '" target="_blank" target="_blank" class="btn-floating btn-small waves-effect waves-light #1565c0 blue darken-3 modal-trigger"><i class="material-icons ">remove_red_eye</i></a> </td>';
